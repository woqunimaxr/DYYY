...
+ (NSDictionary *)settingsDependencyConfig {
    ...
    dispatch_once(&onceToken, ^{
      config = @{
          ...
          // ===== 互斥激活配置 =====
          // 当源设置项关闭时，目标设置项才能激活
          @"mutualExclusions" : @{@"DYYYDanmuRainbowRotating" : @[ @"DYYYDanmuColor", @"DYYYDanmuRandom" ], @"DYYYDanmuRandom" : @[ @"DYYYDanmuColor", @"DYYYDanmuRainbowRotating" ], @"DYYYEnableRandomGradient" : @[ @"DYYYLabelColor" ], @"DYYYSkipPhoto": @[@"DYYYSkipPhotoText"], @"DYYYElementsuofang": @[ @"DYYYNicknameScale", @"DYYYDescriptionScale", @"DYYYIPLabelScale", @"DYYYNicknameVerticalOffset", @"DYYYDescriptionVerticalOffset", @"DYYYIPLabelVerticalOffset" ]},
