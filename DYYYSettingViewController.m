...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"忽略投屏 VPN 检测" key:@"DYYYDisableCastVPNCheck" type:DYYYSettingItemTypeSwitch],
            ...
            [DYYYSettingItem itemWithTitle:@"国外解析账号" key:@"DYYYGeonamesUsername" type:DYYYSettingItemTypeTextField placeholder:@"需填写才能解析国外"],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"昵称缩放控制" key:@"DYYYNicknameScale" type:DYYYSettingItemTypeTextField placeholder:@"不填默认"],
            ...
            [DYYYSettingItem itemWithTitle:@"昵称Y轴距离" key:@"DYYYNicknameVerticalOffset" type:DYYYSettingItemTypeTextField placeholder:@"上移为正下移为负"],
            [DYYYSettingItem itemWithTitle:@"文案Y轴距离" key:@"DYYYDescriptionVerticalOffset" type:DYYYSettingItemTypeTextField placeholder:@"上移为正下移为负"],
            [DYYYSettingItem itemWithTitle:@"属地Y轴距离" key:@"DYYYIPLabelVerticalOffset" type:DYYYSettingItemTypeTextField placeholder:@"上移为正下移为负"],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"精简平板底栏" key:@"DYYYHidePadTabBarElements" type:DYYYSettingItemTypeSwitch],
